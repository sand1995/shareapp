...
import 'package:share_app/pages/edit_profile.dart';
...
import 'package:share_app/widgets/post_tile.dart';
...
class _ProfileState extends State<Profile> {
  ...
  handleUnfollowUser() {
    ...
    // remove their followers collection
    followersRef
        .document(widget.profileId)
        .collection("userFollowers")
        .document(currentUserId)
    ...
    // remove activity feed for new follower to that user
    activityFeedRef
        .document(widget.profileId)
  ...
  handleFollowUser() {
    ...
    // add activity feed for new follower to that user
    activityFeedRef
        .document(widget.profileId)
        .collection("feedItems")
        .document(currentUserId)
